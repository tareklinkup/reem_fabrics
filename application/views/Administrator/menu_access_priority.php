        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="cash_transfer" v-model="access"> Cash Transfer
                    </li>
                    <li><input type="checkbox" class="access" value="cash_transfer_record" v-model="access"> Cash
                        Transfer Record
                    </li>
                    <li><input type="checkbox" class="access" value="cash_transfer_received" v-model="access"> Cash
                        Transfer Receive Record
                    </li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="sale_return_details" v-model="access"> Sales Return
                        Details</li>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="hrPayroll" class="group-head" @click="onClickGroupHeads"> <strong>HR &
                    Payroll</strong>
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="salary_payment" v-model="access"> Salary Payment
                    </li>
                    <li><input type="checkbox" class="access" value="employee" v-model="access"> Add Employee</li>
                    <li><input type="checkbox" class="access" value="emplists/all" v-model="access"> All Employee List
                    </li>
                    <li><input type="checkbox" class="access" value="emplists/active" v-model="access"> Active Employee
                        List</li>
                    <li><input type="checkbox" class="access" value="emplists/deactive" v-model="access"> Deactive
                        Employee List</li>
                    ...
                    <li><input type="checkbox" class="access" value="salary_payment_report" v-model="access"> Salary
                        Payment Report</li>
                </ul>
            </div>
            ...
            <div class="group">
                <input type="checkbox" id="investment" class="group-head" @click="onClickGroupHeads">
                <strong>Investment</strong>
                <ul ref="investment">
                    <li><input type="checkbox" class="access" value="investment_transactions" v-model="access">
                        Investment Transection</li>
                    <li><input type="checkbox" class="access" value="investment_view" v-model="access"> Investment View
                    </li>
                    <li><input type="checkbox" class="access" value="investment_transaction_report" v-model="access">
                        Investment Transaction Report</li>
                    <li><input type="checkbox" class="access" value="investment_ledger" v-model="access"> Investment
                        Ledger</li>
                    <li><input type="checkbox" class="access" value="investment_accounts" v-model="access"> Investment
                        Account</li>
                </ul>
            </div>
            ...
            <div class="group">
                <input type="checkbox" id="requisition" class="group-head" @click="onClickGroupHeads">
                <strong> Requisition</strong>
                <ul ref="requisition">
                    <li><input type="checkbox" class="access" value="product_requisition" v-model="access">
                        Product Requisition</li>
                    <li><input type="checkbox" class="access" value="requisition_list" v-model="access"> Requisition
                        List
                    </li>
                    <li><input type="checkbox" class="access" value="requisition_received_list" v-model="access">
                        Requisition Received List </li>
        ...
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="purchaseReports">
                    ...
                    <li><input type="checkbox" class="access" value="purchase_return_details" v-model="access"> Purchase
                        Return Details</li>
