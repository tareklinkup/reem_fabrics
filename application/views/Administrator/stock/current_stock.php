    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
            ...
            <div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value == 'branch'">
                <div class="col-sm-2" style="margin-left:15px;">
                    <v-select v-bind:options="branch" v-model="selectedBranch" label="Brunch_name"></v-select>
                </div>
            </div>
...
new Vue({
    ...
    methods: {
        getStock() {
            ...
            if (this.searchType == 'branch' && this.selectedBranch == null) {
                alert('Select a Brunch');
                return;
            } else if (this.searchType == 'branch' && this.selectedBranch != null) {
                parameters.branchId = this.selectedBranch.brunch_id;
        ...
        onChangeSearchType() {
            if (this.selectedSearchType.value == 'category' && this.categories.length == 0) {
                ...
                this.getProducts();
            } else if (this.selectedSearchType.value == 'branch' && this.branch.length == 0) {
                this.getBranches();
            }
        },
        getCategories() {
