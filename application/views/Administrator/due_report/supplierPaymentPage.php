            ...
            <form @submit.prevent="saveSupplierPayment">
                <div class="row">
                    <div class="col-md-5 col-md-offset-1">
                        ...
                        <div class="form-group"
                            v-if="selectedSupplier != null && selectedSupplier.Supplier_SlNo != undefined">
                            <label class="col-md-4 control-label">Invoice</label>
                            <label class="col-md-1">:</label>
                            <div class="col-md-7 col-xs-11">
                                <v-select v-bind:options="invoices" v-model="selectedInvoice"
                                    label="PurchaseMaster_InvoiceNo" @input="getSupplierInvoice"> </v-select>
                            </div>
                        </div>
...
new Vue({
    ...
    methods: {
        ...
        getSupplierDue() {
            ...
            axios.post('/get_supplier_due_invoice', {
                customerId: this.selectedSupplier.Supplier_SlNo
            }).then(res => {
        ...
        getSupplierInvoice() {
            this.supplierDue = this.selectedInvoice.invoiceDue
        },
        getAccounts() {
        ...
        saveSupplierPayment() {
            ...
            if (this.selectedInvoice == null || this.selectedInvoice.PurchaseMaster_InvoiceNo == "") {
                alert('Select Invoice');
                return;
            }

            this.payment.SPayment_customerID = this.selectedSupplier.Supplier_SlNo;
            this.payment.PurchaseMaster_InvoiceNo = this.selectedInvoice.PurchaseMaster_InvoiceNo;
        ...
        editPayment(payment) {
            ...
            this.selectedInvoice = payment.PurchaseMaster_InvoiceNo;
