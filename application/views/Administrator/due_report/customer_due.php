...
<div class="row" id="customerDueList">
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
        ...
        <div class="form-group" style="display: none" v-bind:style="{display: searchType == 'invoice' ? '' : 'none'}">
            <label class="col-sm-2 control-label no-padding-right" style="text-align:right">Select Invoice</label>
            <div class="col-sm-3">
                <v-select v-bind:options="invoices" v-model="selectedInvoice" label="invoice_text"
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="data in dues">
                        ...
                        <td style="text-align:right">{{ parseFloat(data.invoiceDue).toFixed(2) }}</td>
                    </tr>
                </tbody>
                <tfoot>
    ...
    methods: {
        onChangeSearchType() {
            if (this.searchType == 'customer' && this.customers.length == 0) {
                this.getCustomers();
            } else if (this.searchType == 'invoice' && this.invoices.length == 0) {
                this.getSales();
            }
        ...
        getDues() {
            ...
            let invoice = this.selectedInvoice == null ? null : this.selectedInvoice.SaleMaster_InvoiceNo;
            ...
            axios.post('/get_customer_due_invoice', {
                ...
                this.totalDue = this.dues.reduce((prev, cur) => {
                    return prev + parseFloat(cur.invoiceDue)
                }, 0);
            })
        },
        async print() {
