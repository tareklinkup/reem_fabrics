...
<div id="transferList">
    <div class="row" style="border-bottom: 1px solid #ccc;">
        <div class="col-md-12">
            <form class="form-inline" @submit.prevent="getRequisition">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody style="display:none;" v-bind:style="{display: requisitions.length > 0 ? '' : 'none'}">
                        <tr v-for="(requisition, sl) in requisitions">
                            ...
                            <td>{{ requisition.requisition_from_name }}</td>
                            <td>{{ requisition.note }}</td>
                            <td><a href="" v-bind:href="`/requisition_invoice/${requisition.requisition_id}`"
                                    target="_blank" title="View invoice"><i class="fa fa-file"></i></a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
new Vue({
    ...
    methods: {
        ...
        getRequisition() {
            ...
            axios.post('/get_requisition_receives', this.filter).then(res => {
