        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-bordered" style="display:none;"
                    v-bind:style="{display: transfers.length > 0 ? '' : 'none'}">
                    <thead>
                        <tr>
                            <th>Sl</th>
                            <th>Transfer Date</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th>{{transfers.reduce((prev, curr)=>{ return prev + parseFloat(curr.transfer_amount)}, 0)}}
                            </th>
                        </tr>
                    </tfoot>
                </table>
...
new Vue({
    ...
    methods: {
        ...
        getTransfers() {
            ...
            axios.post('/get_cash_transfers', this.filter).then(res => {
