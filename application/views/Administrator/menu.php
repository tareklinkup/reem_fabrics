...
<ul class="nav nav-list">
    ...
    <?php if (
			array_search("product_requisition", $access) > -1
			|| array_search("requisition_list", $access) > -1
			|| array_search("requisition_received_list", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
    <li class="">
        <a href="<?php echo base_url(); ?>" class="dropdown-toggle">
            <i class="menu-icon fa fa-exchange"></i>
            <span class="menu-text"> Product Requisition </span>
            <b class="arrow fa fa-angle-down"></b>
        </a>
        ...
        <ul class="submenu">
            ...
            <?php if (array_search("product_requisition", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>product_requisition">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Product Requisition
                </a>
                <b class="arrow"></b>
            ...
            <?php endif; ?>
            <?php if (array_search("requisition_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>requisition_list">
                    <i class="menu-icon fa fa-caret-right"></i>
                    Requisition List
                </a>
                <b class="arrow"></b>
            ...
            <?php if (array_search("requisition_received_list", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
            <li class="">
                <a href="<?php echo base_url(); ?>requisition_received_list">
                    <i class="menu-icon fa fa-caret-right"></i>
                    <span class="menu-text">Requisition Received List</span>
                </a>
                <b class="arrow"></b>
            </li>
            <?php endif; ?>
